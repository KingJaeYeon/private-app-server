...
// 클라이언트에 상세 정보 노출 금지 - serverMessage: logOnly message
export const GLOBAL_ERROR_CODES = {
  ...
  DATABASE_CONNECTION_FAILED: defineError(
    'INTERNAL-002',
    '일시적인 오류가 발생했습니다. 잠시 후 다시 시도해주세요',
    HttpStatus.INTERNAL_SERVER_ERROR,
  ...
  BLACKLIST_IP: defineError(
    'GLOBAL-002',
    '요청을 처리할 수 없습니다. 관리자에게 문의하세요.',
    HttpStatus.FORBIDDEN,
    'Blocked by security policy – IP blacklisted.',
    'GLOBAL'
  ),
...
export const BASE_ERROR_CODES = {
  ...
  UNAUTHORIZED: defineError('AUTH-004', '인증이 필요합니다', HttpStatus.UNAUTHORIZED),
  FORBIDDEN: defineError('AUTH-005', '접근 권한이 없습니다', HttpStatus.FORBIDDEN),
  USER_DAILY_QUOTA_EXCEEDED: defineError('AUTH-006', '쿼터 사용량 초가', HttpStatus.UNAUTHORIZED),
  ...
  TOO_MANY_REQUEST_BLOCK: defineError(
    'COMMON-005',
